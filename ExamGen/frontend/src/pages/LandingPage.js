  ...
  return (
    <div className="relative min-h-screen bg-[#010810] text-slate-100 font-sans selection:bg-emerald-500/30 overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0">
        <div className="absolute top-[-20%] right-[-10%] w-[80%] h-[80%] bg-emerald-600/10 blur-[150px] rounded-full animate-smooth-pulse" />
        <div className="absolute bottom-[-10%] left-[-10%] w-[60%] h-[60%] bg-blue-600/10 blur-[150px] rounded-full animate-smooth-pulse delay-1000" />
        <div 
          className="absolute inset-0 opacity-[0.15] grid-mask-enhanced"
        />
      </div>
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="w-full lg:w-3/5 space-y-8 animate-fade-in-left">
          <div className="inline-flex items-center gap-3 px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-emerald-400">
              V1.0.4 Deploying AI Models
            </span>
          </div>

          <h1 className="text-6xl md:text-8xl font-black tracking-tighter leading-[0.9]">
            The <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400 text-shimmer">Architect</span> <br /> 
            of Modern Exams.
          </h1>
          ...
          <div className="flex flex-wrap gap-5 pt-4">
            {!teacher ? (
              <>
                <Link 
                  to="/register" 
                  className="px-8 py-4 bg-emerald-500 text-slate-950 font-black rounded-xl hover:bg-emerald-400 hover:-translate-y-1 hover:shadow-[0_20px_40px_-10px_rgba(16,185,129,0.4)] transition-all duration-300"
                >
                  Initialize Workspace
                </Link>
                <Link 
                  to="/login" 
                  className="px-8 py-4 bg-white/5 border border-white/10 text-white font-black rounded-xl hover:bg-white/10 backdrop-blur-md transition-all"
                >
                  Secure Login
                </Link>
              </>
              ...
              <button 
                ...
                className="px-10 py-4 bg-white text-slate-900 font-black rounded-xl hover:scale-105 transition-transform shadow-2xl"
              >
        ...
        <div className="w-full lg:w-2/5 relative perspective-1000">
          <div className="relative bg-gradient-to-br from-white/10 to-transparent p-1 border border-white/20 rounded-[3rem] shadow-2xl rotate-y-[-15deg] hover:rotate-y-[0deg] transition-all duration-1000 group">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="md:col-span-2 p-8 bg-white/[0.03] border border-white/10 rounded-[2.5rem] hover:border-emerald-500/50 transition-all group">
            ...
            <p className="text-slate-500 text-sm">
              Track how questions perform across different difficulty tiers and batches.
            </p>
          </div>
      ...
      <style>{`
        ...
        .animate-fade-in-left { 
          animation: fade-in-left 1.2s cubic-bezier(.22,1,.36,1) forwards; 
        }
        ...
        .grid-mask-enhanced {
          background-image: radial-gradient(rgba(16,185,129,0.6) 0.5px, transparent 0.5px);
