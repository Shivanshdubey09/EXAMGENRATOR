...
//     if (questionType !== 'SHORT' && options.some(o => !o.trim())) {
...
//     try {
//       await API.put(`/questions/bank/${id}`, {
...
//   return (
//     <div className="min-h-screen bg-[#050505] text-slate-100 p-6 md:p-10 font-sans">
//       <div className="max-w-7xl mx-auto space-y-10">

//         {/* ===== PAGE HEADER ===== */}
//         <header className="animate-fade-up">
//           <h1 className="text-4xl font-black italic tracking-tight">
//             Question <span className="text-indigo-500">Bank</span>
//           </h1>
//           <p className="text-slate-500 text-sm mt-1">
//             Create, manage and reuse your questions efficiently
//           </p>
//         </header>

//         {/* ===== ADD QUESTION ===== */}
//         <section className="bg-slate-900/40 border border-slate-800 rounded-3xl p-6 md:p-8 backdrop-blur animate-fade-up">
...
//             className="w-full bg-black/40 border border-slate-700 rounded-xl p-4 mb-4
...
//                   className="w-full bg-black/40 border border-slate-700 rounded-xl p-3"
//                 />
//               ))}
//             </div>
//           )}
...
//               font-bold transition shadow-lg shadow-indigo-600/30"
//           >
