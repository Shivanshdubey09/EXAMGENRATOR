...
//           <p className="mb-6 text-slate-400">Your session has expired.</p>
//           <button
...
//   return (
//     <div className="min-h-screen bg-[#050505] text-slate-100 p-4 md:p-10 font-sans">
...
//               Here is what's happening with your exam papers today.
//             </p>
//           </div>
...
//               className="bg-indigo-600 hover:bg-indigo-500 hover:scale-105
//                 transition-all px-5 py-2.5 rounded-xl
//                 text-sm font-bold shadow-lg shadow-indigo-500/20"
//             >
//               + Create New Paper
//             </button>
...
//                 font-bold border border-slate-700 transition-all"
//             >
//               Question Bank
//             </button>
//           </div>
...
//         {/* --- STATS GRID --- */}
//         <div className="grid grid-cols-1 md:grid-cols-4 gap-4 animate-in fade-in zoom-in duration-1000">
//           <StatCard title="Total Papers" value={papers.length} color="text-indigo-400" />
//           <StatCard
//             title="Total Questions"
//             value={papers.reduce((acc, p) => acc + (p.questions?.length || 0), 0)}
...
//             isString
//           />
//           <div className="bg-indigo-600/10 border border-indigo-500/20 rounded-2xl p-6 flex flex-col justify-center">
//             <p className="text-[10px] uppercase tracking-widest text-indigo-400 font-bold mb-1">
//               System Status
//             </p>
//             <p className="text-lg font-bold">AI Engine Online</p>
//           </div>
//         </div>

//         {/* --- MAIN CONTENT AREA --- */}
//         <main className="bg-slate-900/30 border border-slate-800/50 rounded-3xl p-6 md:p-8 backdrop-blur-sm">
//           <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
//             <h2 className="text-2xl font-bold">Recent Generations</h2>
//             <input
//               type="text"
//               placeholder="Search by title or subject..."
//               className="w-full md:w-80 bg-black/40 border border-slate-700
...
//               {[1, 2, 3].map(i => (
//                 <div key={i} className="h-48 bg-slate-800/50 animate-pulse rounded-2xl" />
//               ))}
//             </div>
//           ) : filteredPapers.length === 0 ? (
//             <div className="py-20 text-center border-2 border-dashed border-slate-800 rounded-3xl">
//               <p className="text-slate-500">No papers match your search criteria.</p>
//             </div>
//           ) : (
//             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
//               {filteredPapers.map((paper) => (
//                 <div key={paper._id} className="group hover:-translate-y-2 transition-all duration-300">
...
// const StatCard = ({ title, value, color, isString = false }) => (
...
//       {title}
//     </p>
//     <p className={`text-3xl font-black ${color} ${isString ? 'text-xl' : ''}`}>
//       {value}
//     </p>
//   </div>
// );
